    ...
    <main class="tool-main">
      ...
      <div class="right-panel">
        <div class="tab-content">
          <label class="field-label">阴影类型</label>
          <select v-model="shadowType" class="field-select">
            <option value="soft">柔和自然</option>
...
const shadowType = ref('soft');

const shadowLabels: Record<string, string> = {
  soft: '柔和自然的软阴影，适合白底展示',
  drop: '清晰投影效果',
  subtle: '轻微阴影，自然不抢眼',
};
...
【任务】图中是商品产品图（可能白底），请为商品智能添加自然的${shadow}。
