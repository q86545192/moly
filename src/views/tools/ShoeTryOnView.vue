    ...
    <main class="tool-main">
      <aside class="upload-panel">
        <div class="upload-section">
          <div class="section-label">鞋款图（白底更佳）</div>
      ...
      <div class="right-panel">
        ...
        <div class="preview-area">
          ...
          <div v-if="!resultImage && !isGenerating" class="preview-empty">上传鞋款图，点击生成</div>
...
async function generate() {
  ...
  const prompt = `请生成一张AI试鞋效果图：

【任务】图中是鞋款产品图，请生成真人模特穿着这双鞋的展示图。
